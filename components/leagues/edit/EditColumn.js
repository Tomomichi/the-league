    ...
    <>
      ...
      <div className={`${menu['target'] == 'share' ? '' : 'hidden'}`}>
        ...
        <div className="mb-8">
          ...
          <div className="flex">
            <a href={`https://twitter.com/share?url=https://the-league.vercel.app/leagues/${league.id}&text=${league.title}のリーグ表%20-%20THE%20LEAGUE(ザ・リーグ)%20簡単・便利な無料総当りリーグ表作成ツール&hashtags=the_league`} target="_blank" className="rounded bg-blue-600 text-white flex items-center px-4 py-2 w-auto mr-4 hover:opacity-75">
            ...
            <a href={`https://www.facebook.com/share.php?u=https://the-league.vercel.app/leagues/${league.id}`} target="_blank" className="rounded bg-blue-800 text-white flex items-center px-4 py-2 w-auto hover:opacity-75">
              <svg className="w-5 h-5 fill-current mr-1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
