    ...
    <>
      ...
      <div className="mb-32">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 sm:gap-4 text-sm mb-8">
          <div className="border rounded px-2 py-3">試合順の自動生成</div>
          <div className="border rounded px-2 py-3">独自ランキングロジック</div>
          <div className="border rounded px-2 py-3">外部サイト埋め込み</div>
          <div className="border rounded px-2 py-3">文字でのスコア登録</div>
          <div className="border rounded px-2 py-3">参加者シャッフル</div>
          <div className="border rounded px-2 py-3">参加者の所属表示</div>
          <div className="border rounded px-2 py-3">スコアなし（勝敗のみ記録）</div>
          <div className="border rounded px-2 py-3">画像ダウンロード</div>
          <div className="border rounded px-2 py-3">API連携</div>
          <div className="border rounded px-2 py-3">デザインカスタマイズ</div>
          <div className="border rounded px-2 py-3">選手の顔写真表示</div>
          <div className="border rounded px-2 py-3">試合詳細コメント</div>
          <div className="border rounded px-2 py-3">OEM提供</div>
        </div>
